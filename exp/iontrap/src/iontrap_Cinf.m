...
dname=strcat(dpath,"iontrap_Cinf.mat");

% Set the figure path
fpath=strcat(mpath,'fig/');
fname=strcat(fpath,'iontrap_Cinf.eps');
...
if ~isfile(dname)
    ...
    % Set C-infinity cutoff function
    cut=@(x)1-trans3(rho1,rho2,Inf,x);
